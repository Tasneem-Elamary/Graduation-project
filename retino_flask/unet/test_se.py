...
model = load_model('unet/se_model/soft_model.h5' , custom_objects={"IOU": IOU,"dice_coef":dice_coef})
...
# 	saver = tf.compat.v1.train.import_meta_graph("unet/se_model/model.ckpt.meta")
# 	sess = tf.compat.v1.InteractiveSession()
# 	saver.restore(sess, "unet/se_model/model.ckpt")
