...
model = load_model('unet/ma_model/model_99.h5' , custom_objects={"IOU": IOU,"dice_coef":dice_coef})
...
# 	saver = tf.compat.v1.train.import_meta_graph("unet/ma_model/model.ckpt.meta")
# 	sess = tf.compat.v1.InteractiveSession()
# 	saver.restore(sess, "unet/ma_model/model.ckpt")
...
# # output_save = predict_ma(image)
# # output_save.save("predicted_ma.jpg", "JPEG")