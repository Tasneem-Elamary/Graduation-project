...
model = load_model('unet/ex_model/model_hard_60.h5' , custom_objects={"IOU": IOU,"dice_coef":dice_coef})
...
# def predict_ex(image):
	
# 	saver = tf.compat.v1.train.import_meta_graph("unet/ex_model/model.ckpt.meta")
# 	sess = tf.compat.v1.InteractiveSession()
# 	saver.restore(sess, "unet/ex_model/model.ckpt")
...
# # output_save = predict_ex(image)
# # output_save.save("predicted_ex.jpg", "JPEG")